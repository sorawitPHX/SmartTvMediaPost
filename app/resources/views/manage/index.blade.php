    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-600 mb-1">Smart TV ทั้งหมด</p>
                        <p class="text-2xl font-bold text-gray-900">{{ number_format($totalSmartTv) }}</p>
                        <p class="text-xs text-primary flex items-center mt-1">
                    ...
                    <div class="w-12 h-12 bg-primary-content rounded-xl flex items-center justify-center">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
            ...
            <div class="xl:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <span class="px-3 py-1 bg-blue-100 text-blue-700 text-sm font-medium rounded-full">ล่าสุด
                        {{ $totalPosts }} รายการ</span>
                </div>
                <div class="space-y-4">
                        ...
                        <div
                                ...
                                @if (!$post->is_public)
                                    <div
                                        ...
                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L6.636 6.636m3.242 3.242l4.242 4.242m0 0L17.364 17.364M9.878 9.878l-3.242-3.242m0 0L3.636 3.636">
                                            </path>
                                        </svg>
                                    </div>
                                @endif
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex items-center gap-3 mt-1">
                                    ...
                                    <span
                                        class="badge badge-primary inline-flex items-center px-2 py-1 rounded-full text-xs font-medium">
                                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z">
                                    ...
                                    <span
                                        class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium {{ $post->is_public ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <span
                            class="px-3 py-1 bg-purple-100 text-purple-700 text-sm font-medium rounded-full">{{ $latestUsers->count() }}</span>
                    </div>
                    <div class="space-y-3">
                        @forelse ($latestUsers as $user)
                            <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                                <div
                                    class="w-10 h-10 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full flex items-center justify-center text-white font-semibold text-sm">
                                ...
                                <span
                                    class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium {{ $user->role === 'admin' ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800' }}">
                                    {{ $user->role }}
                                </span>
                            </div>
                        @empty
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="w-full bg-indigo-400 rounded-full h-2">
                            <div class="bg-white h-2 rounded-full"
                                style="width: {{ min(($totalPosts / 1000) * 100, 100) }}%"></div>
                        </div>
